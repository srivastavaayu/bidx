...
//    OTP verification and new password check 
        ...
        <section class= "container">
            ...
            <form onSubmit={sendOTP}>
                <div class="form-floating mb-3 mt-5">
                    <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" onChange={sendDetails}
                    name = "email"
                    value = {email.Email}/>
        ...
        :
            <section class= "container">
                ...
                <form onSubmit={submitOTP}>
                    <div class="form-floating mb-3 mt-5">
                        <input type="number" class="form-control" id="floatingInput" placeholder="name@example.com" onChange={subotp}
                        name = "otp"
                        value = {otp.Otp}/>
                        <label for="floatingInput">Enter Your OTP</label>
                    </div>
                    <div class="form-floating mb-3 mt-5">
                        <input type="password" class="form-control" id="floatingInput" placeholder="name@example.com" onChange={subotp}
                        name = "password1"
                        value = {otp.pass1}/>
