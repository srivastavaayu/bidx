            ...
            <section className= "container">
                ...
                <div className= "row mt-5 setbg">
                        <div className= "col-lg-6 col-10 p-4">
                            <h3 className= "text-danger"><b>{user? user.firstName : ""} {user? user.lastName : ""}</b></h3>
                            <h5><b>{user?user.username:""}</b></h5>
                            <h5><span className= "text-danger">Email Id : </span>{user? user.email:""}</h5>
                            <h5><span className= "text-danger">Phone : </span>{user?user.phone:""}</h5>
                        </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="row">
                        {yourbids&&yourbids.map((val,index)=>{
                            return(<>
                                <div class="card my-3">
                                    <div class="card-header">
                                        <b>{val?val.prodName:""}</b> (Sold by : {val?val.creatorName:""})
                                    </div>
                                    <div class="card-body">
                                        <h5 class="card-title">Base Price : {val?val.basePrice : ""} <b className="text-danger ms-lg-5 ms-1">Max Bid : </b>{val?val.biddingPrice:""}</h5>
                    ...
                    <div className="row">
                        {items&&items.map((val,index)=>{
                            return(<>
                                <div class="card my-3">
                                    <div class="card-header">
                                        <b>{val?val.prodName:""}</b> ({val?val.category:""})
                                    </div>
                                    <div class="card-body">
                                        <h5 class="card-title">Base Price : {val.basePrice?val.basePrice:""} <b className="text-danger ms-lg-5 ms-1">Max Bid : </b>{val.biddingPrice?val.biddingPrice:""}</h5>
